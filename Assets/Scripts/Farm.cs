...
public class Farm : MonoBehaviour{
    ...
    void Start(){
        ...
        EventNotif = GetComponent<TextMeshProUGUI>();
    }
    ...
    double event_check(){
        ...
        if(farm_event < 75){
            //do nothing
            modifier = 1;
            EventNotif.text = "All is good";
        }
        //Animals eat harvest - loose 3/4 crop yield
        else if(farm_event > 75 && farm_event < 80){
            modifier = .25;
            EventNotif.text = "Animals have gotten into your field and ate most of your crops";
        }
        //Drought - loose 1/2 crop yield
        else if(farm_event > 80 && farm_event < 85){
            modifier = .5;
            EventNotif.text = "Your farm couldn't get enough water, half your crops have withered";
        }
        //Rotten - loose 1/4 crop yield
        else if(farm_event > 85 && farm_event < 90){
            modifier = .75;
            EventNotif.text = "A quarter of your crops have rotted";
        }
        // //another event?
